...
class IcısleriLogın:
    ...
    def __init__(self):
        ...
        browserpath = r"C:\chromedriver\chromedriver.exe"  # this is win os path
    ...
    def getCaptcha(self):
        ...
        self.browser.save_screenshot(r"\tmp\captcha.png")  # time.sleep(1)
    ...
    def cropCaptcha(self,resim_adi):
        ...
        crop_img.load()
        crop_img.save(r"\tmp\cropped.png")  # time.sleep(1)
    ...
    def getHMTLSourceCode(self):
        ...
        if len(all_ul)>=18:
            counter_values=all_ul[1].get_text(),all_ul[2].get_text(),all_ul[13].get_text(),all_ul[14].get_text(),all_ul[15].get_text(),all_ul[18].get_text()
...
if __name__=="__main__":
    ...
    check.wait(1)
    check.sendKeys(k_sifre,'de273-kdv')
    check.getCaptcha()
    check.wait(1)
    check.cropCaptcha(r".\tmp\captcha.png")
    check.wait(1)
    check.showCaptcha()
###inputing##
    check.inputCaptcha()
