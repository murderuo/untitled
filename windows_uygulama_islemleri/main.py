...
for program in programs:
    ...
    if program["exe_name"] == "iexplore.exe" and program["title_name"] == "e-İÇİŞLERİ PROJESİ - Internet Explorer":
        # win32gui.SetFocus(program["pid"][1])
        # win32gui.BringWindowToTop()
        # win32gui.SetForegroundWindow(program["pid"][1])
        # win32gui.ShowWindow(program["pid"][1],3)
        win32gui.SetActiveWindow(program["pid"][0])
